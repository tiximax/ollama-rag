...
class ProfileResult:
    ...
    def print_summary(self) -> None:
        ...
        print(f"\n{'='*80}")
        print(f"⚡ Query Performance Profile")
        print(f"{'='*80}")
        print(f"Query: {self.query[:60]}...")
        print(f"Total Duration: {self.total_duration_ms:.0f}ms ({self.total_duration_ms/1000:.2f}s)")
...
class QueryProfiler:
    ...
    def __init__(self, enable_memory_tracking: bool = True):
        ...
        self._current_profile: Optional['_ProfileContext'] = None
    ...
    def get_last_result(self) -> Optional[ProfileResult]:
    ...
    def get_aggregate_stats(self) -> Dict[str, Any]:
        ...
        step_averages = {
            name: stats["total_ms"] / stats["count"]
...
class _StepContext:
    ...
    def __init__(self, profile_ctx: _ProfileContext, name: str, metadata: Dict[str, Any]):
        ...
        self.step: Optional[ProfileStep] = None
