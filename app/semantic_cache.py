...
class SemanticQueryCache:
    ...
    def get(
        ...
        Quy trình:
        1. Check exact match (nhanh nhất) 🔍
        2. Nếu không có, tính embedding và tìm similar queries 🧠
        3. Nếu tìm thấy query với similarity > threshold → Cache HIT! 🎉
        
        Args:
            query: Query string để search
            embedder: Function hoặc object có thể tạo embedding
                     Cần có interface: embedder([query]) -> list[embedding]
